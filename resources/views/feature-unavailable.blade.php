...
<div class="send-wrap">
  ...
  <div class="card-detail-card fade-in d2" style="text-align:center; padding:36px 24px;">
    ...
    <p style="margin:0 0 8px; font-size:16.5px; font-weight:700;"><?= e($feature) ?> <?= e(__('feature.unavailable_suffix')) ?></p>
    ...
    <div style="display:flex; gap:10px; justify-content:center; flex-wrap:wrap;">
      <a href="<?= e(route('dashboard')) ?>" class="btn btn-outline"><?= e(__('feature.back_to_dashboard')) ?></a>
      <a href="<?= e(route('support')) ?>" class="btn btn-primary"><?= e(__('feature.message_support')) ?></a>
    </div>
  </div>
