...
<body style="margin:0;padding:0;background:#F1EFE7;font-family:'Segoe UI',Helvetica,Arial,sans-serif;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
        Your Ledger verification code: <?= e($code) ?>. It expires in 10 minutes.
    </div>
                    ...
                    <tr>
                        <td style="background:#FFFFFF;border:1px solid #EDEAE0;border-top:none;border-radius:0 0 16px 16px;padding:44px 36px 36px;text-align:center;">
                            ...
                            <p style="margin:0 auto 28px;max-width:340px;font-size:14.5px;line-height:1.7;color:#5C6B72;">
                                Enter this code to confirm it's really you finishing your Ledger account.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:28px;background:#F7EDD9;border-radius:10px;">
                                <tr>
                                    <td style="padding:14px 18px;">
                                        <p style="margin:0;font-size:12.5px;line-height:1.6;color:#7a6636;">
                                            Didn't request this? You can safely ignore this email. Your account stays exactly as it is.
                                        </p>
                                    </td>
                                </tr>
                            </table>
