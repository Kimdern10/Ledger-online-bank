...
@section('content')
  ...
  <div class="admin-stat-row">
    <div class="admin-stat is-dark">
      ...
      <p class="value"><?= e(number_format($userCount)) ?></p>
    </div>
    <div class="admin-stat is-dark">
      <div class="admin-stat-icon">
      ...
      <p class="value"><?= e(number_format($activeCount)) ?></p>
    </div>
    <div class="admin-stat is-danger">
      ...
      <p class="value"><?= e(number_format($inactiveCount)) ?></p>
    </div>
    <div class="admin-stat">
      ...
      <p class="value"><?= e(number_format($billCount)) ?></p>
    </div>
    <div class="admin-stat">
      <div class="admin-stat-icon">
      ...
      <p class="value">$<?= e(number_format($totalBalance, 2)) ?></p>
    </div>
  </div>
  ...
  <div class="admin-card">
    ...
    <p style="margin:0; color:var(--admin-text-2); font-size:13.5px;">
      Use <a href="<?= e(route('admin.users')) ?>" style="color:var(--admin-accent); font-weight:600;">Users</a> to look up an account, open its detail page, or adjust a balance,
      or <a href="<?= e(route('admin.bills')) ?>" style="color:var(--admin-accent); font-weight:600;">Bills</a> to see and remove anything added across every account.
    </p>
  </div>
@endsection
