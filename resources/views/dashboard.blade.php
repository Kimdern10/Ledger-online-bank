...
@section('content')
    ...
    <script>
      window.LedgerDashboardConfig = {
        ...
        acctAriaTemplate: @json(__('dashboard.acct_aria', ['label' => '__LABEL__'])),
        csrfToken: '{{ csrf_token() }}',
        notifEmptyText: @json(__('dashboard.no_notifications')),
        clearAllConfirmText: @json(__('dashboard.clear_all_confirm')),
        clearAllText: @json(__('dashboard.clear_all')),
      };
    </script>
