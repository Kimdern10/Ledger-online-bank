<nav class="sidenav">
    ...
    <a href="<?= route('home') ?>" class="nav-item <?= request()->routeIs('home') ? 'active' : '' ?>">
        ...
        <span class="label"><?= e(__('dashboard.nav_home')) ?></span>
    </a>
    <a href="<?= route('card') ?>" class="nav-item <?= request()->routeIs('card') ? 'active' : '' ?>">
        ...
        <span class="label"><?= e(__('dashboard.nav_cards')) ?></span>
    </a>
    <a href="<?= route('scan') ?>" class="nav-item <?= request()->routeIs('scan') ? 'active' : '' ?>">
        ...
        <span class="label"><?= e(__('dashboard.nav_pay_scan')) ?></span>
    </a>
    <a href="<?= route('setting') ?>" class="nav-item <?= request()->routeIs('setting') ? 'active' : '' ?>">
        ...
        <span class="label"><?= e(__('dashboard.nav_profile')) ?></span>
    </a>
    ...
    <div class="nav-fab-row">
        <a href="#" class="nav-item cta <?= request()->routeIs('send') ? 'active' : '' ?>">
            ...
            <span class="label"><?= e(__('dashboard.nav_send_money')) ?></span>
        </a>
    </div>
</nav>
