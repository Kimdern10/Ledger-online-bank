...
@section('content')
  {{-- .section-label and .admin-select aren't in the shared admin layout —
       each admin page that uses them defines its own copy (see
       admin-users-show.blade.php / admin-support.blade.php), so this page
       does the same rather than silently depending on another page having
       been loaded first. --}}
  <style>
