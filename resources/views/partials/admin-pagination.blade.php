...
@if($paginator->hasPages())
  ...
  <div class="admin-pagination">
    ...
    <div class="admin-pagination-links">
      <a href="{{ $paginator->previousPageUrl() ?? '#' }}" class="admin-page-link @disabled($paginator->onFirstPage())" aria-label="Previous page">&larr;</a>
      ...
      <a href="{{ $paginator->nextPageUrl() ?? '#' }}" class="admin-page-link @disabled(! $paginator->hasMorePages())" aria-label="Next page">&rarr;</a>
    </div>
  </div>
@endif
